...
public final class SimpleExoPlayerView extends FrameLayout {
  ...
  /**
   *
   * Custom method to get PlayerControlView
   * Used for getting callbacks for events
   * */
  ...
  /**Improvised method getting notified of lifecycle of list activity to get the lifecycle events*/
